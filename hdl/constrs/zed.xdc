...
#set_property PACKAGE_PIN Y11  [get_ports {uart_rtl_rxd}];  # "JA1"
#set_property PACKAGE_PIN AA11 [get_ports {uart_rtl_txd}];  # "JA2"
#set_property PACKAGE_PIN Y10  [get_ports {iic_rtl_scl_io}];  # "JA3"
#set_property PACKAGE_PIN AA9  [get_ports {iic_rtl_sda_io}];  # "JA4"
...
set_property PULLUP true [get_ports iic_bl_scl_io]
set_property PULLUP true [get_ports iic_bl_sda_io]
